...
class MonsterParser:
    ...
    def _build_lookup_map(self) -> None:
        for monster_id, monster in self._monster_registry.items():
            ...
            self.name_map[name] = monster_id

    def get_instance(self, monster_name: str) -> MonsterInstance:
        monster_id: str = self.name_map[monster_name.lower()]
        monster_instance = MonsterInstance(monster_id=monster_id)
